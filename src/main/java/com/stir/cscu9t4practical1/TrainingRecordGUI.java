...
public class TrainingRecordGUI extends JFrame implements ActionListener {
	...
	private JTextField where = new JTextField(8);
	...
	private JLabel labw = new JLabel(" Pool:");
	...
	public String FindAllEntry() {
		...
		String message = myAthletes.findAllList(d, m, y);
		return message;
	}
	...
	public String removerec() {
		...
		String message = myAthletes.removeList(n, d, m, y);
		return message;
	}
